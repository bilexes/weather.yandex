...
LDAYS = { 'пн': xbmc.getLocalizedString( 11 ),
          'вт': xbmc.getLocalizedString( 12 ),
          'ср': xbmc.getLocalizedString( 13 ),
          'чт': xbmc.getLocalizedString( 14 ),
          'пт': xbmc.getLocalizedString( 15 ),
          'сб': xbmc.getLocalizedString( 16 ),
          'вс': xbmc.getLocalizedString( 17 )}

DAYS = { 'пн': xbmc.getLocalizedString( 41 ),
         'вт': xbmc.getLocalizedString( 42 ),
         'ср': xbmc.getLocalizedString( 43 ),
         'чт': xbmc.getLocalizedString( 44 ),
         'пт': xbmc.getLocalizedString( 45 ),
         'сб': xbmc.getLocalizedString( 46 ),
         'вс': xbmc.getLocalizedString( 47 )}

def get_icons(yandex_icon):
    icon = {  'ovc':        26,
              'ovc-sn':     16,
              'ovc-p-sn':   41,
              'ovc-m-sn':   14,
              ...
              'skc-d':      32,
              'skc-n':      31 }
    return str(icon.get(yandex_icon, 'na'))
